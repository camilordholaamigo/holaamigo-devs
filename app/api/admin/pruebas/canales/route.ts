...
/**
 * POST /api/admin/pruebas/canales — nuestra línea, editable sin desplegar.
 *
 * El número desde el que escribimos y su identificador en Callbell son datos
 ...
 * secreto.
 *
 * `channel_uuid` no se valida contra Callbell acá. La validación de verdad es
 * mandar un mensaje, y eso lo hace el botón de prueba de la pantalla: un
